...
\begin{table}[p]
  ...
  \begin{tabular}{p{0.65in}|p{1.45in}|p{1.65in}|p{1.35in}}
    ...
    Weeks 4--5 & Motion primitives and selective refinement & Generated target flow using $F(p)=T(p)-p$ and weighted guidance using $\gamma_{\mathrm{in}}$ and $\gamma_{\mathrm{out}}$ & Primitive control improved usability, but flow-only guidance was weak \\ \hline
